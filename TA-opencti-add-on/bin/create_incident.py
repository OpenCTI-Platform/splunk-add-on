...
import modalert_create_incident_helper
    ...
    def process_event(self, *args, **kwargs):
        ...
        try:
            if not self.validate_params():
                return 3
            status = modalert_create_incident_helper.process_event(self, *args, **kwargs)
...
if __name__ == "__main__":
    exitcode = AlertActionWorkercreate_incident("TA-opencti-add-on", "create_incident").run(sys.argv)
    sys.exit(exitcode)
