...
import modalert_create_incident_response_helper
    ...
    def process_event(self, *args, **kwargs):
        ...
        try:
            if not self.validate_params():
                return 3
            status = modalert_create_incident_response_helper.process_event(self, *args, **kwargs)
...
if __name__ == "__main__":
    exitcode = AlertActionWorkercreate_incident_response("TA-opencti-add-on", "create_incident_response").run(sys.argv)
    sys.exit(exitcode)
